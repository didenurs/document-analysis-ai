...
# Pipeline yerine Modeli ve Tokenizer'ı doğrudan yüklüyoruz
...
def generate_summary(text: str) -> str:
    ...
    # Gelen metni yapay zekanın anlayacağı sayılara çeviriyoruz
    ...
    # Modelden çıkan sayıları tekrar okunabilir insan diline çeviriyoruz
